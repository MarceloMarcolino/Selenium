...
class Booking(webdriver.Chrome):
	...
	def change_language(self, language=None):
		...
		selected_language_element = self.find_element(By.CSS_SELECTOR, f'a[data-lang="{language}"]')
		selected_language_element.click()

	def change_currency(self, currency=None):
		currency_element = self.find_element(By.CSS_SELECTOR, 'button[data-modal-header-async-type="currencyDesktop"]')
	...
	def select_adults(self, count=1):
		...
		while True:
			decrease_adults_element = self.find_element(By.CSS_SELECTOR, 'button[aria-label="Diminuir número de Adultos"]')
		...
		increase_button_element = self.find_element(By.CSS_SELECTOR, 'button[aria-label="Aumentar número de Adultos"]')
